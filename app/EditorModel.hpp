...
public:
    ...
    void setCursorColumn(unsigned int col);
    void setCursorLine(unsigned int line);
    void setLineCount(unsigned int lCount);
    std::string returnLineContent(unsigned int lineNum);
    void changeLineContent(unsigned int lineNum, std::string& content);
    void addNewLine(unsigned int lineNum, std::string& content);
...
private:
    ...
    unsigned int totalLineNumber = 1;
